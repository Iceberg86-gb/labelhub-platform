...
public class AiCallEntity {
    ...
    public Long getAiReviewRuleId() { return aiReviewRuleId; }
    public void setAiReviewRuleId(Long aiReviewRuleId) { this.aiReviewRuleId = aiReviewRuleId; }
