...
public class PlatformUserRoleService {
    ...
    public PlatformUserRoleService(UserMapper userMapper, AuditLogService auditLogService) {
    ...
    public UserRoleUpdateResult updateRole(Long actorUserId, Long targetUserId, UserRoleCommand command) {
        if (actorUserId != null && actorUserId.equals(targetUserId)) {
            throw new InvalidUserRoleAssignmentException("Platform admin cannot grant roles to self");
        }
