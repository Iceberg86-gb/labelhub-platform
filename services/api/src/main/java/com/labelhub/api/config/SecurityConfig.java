    ...
    SecurityFilterChain securityFilterChain(
        ...
        return http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/llm/**").hasRole("PLATFORM_ADMIN")
                .requestMatchers(HttpMethod.GET, "/users").hasRole("PLATFORM_ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/users/*").hasRole("PLATFORM_ADMIN")
                ...
                .requestMatchers(HttpMethod.GET, "/tasks/*/ai-prereview/summary").hasRole("OWNER")
                .requestMatchers(HttpMethod.POST, "/tasks/*/ai-prereview/enqueue").hasRole("OWNER")
                .requestMatchers(HttpMethod.GET, "/tasks/*/workflow-progress").hasRole("OWNER")
                ...
                .requestMatchers(HttpMethod.POST, "/tasks/*/claim-batch").hasRole("LABELER")
                .requestMatchers("/sessions/**").hasRole("LABELER")
                .requestMatchers("/my/sessions").hasRole("LABELER")
                .requestMatchers(HttpMethod.POST, "/submissions/*/ai-prereview/enqueue").hasRole("OWNER")
                ...
                .requestMatchers(HttpMethod.GET, "/reviewer/submissions").hasAnyRole("REVIEWER", "SENIOR_REVIEWER")
                .requestMatchers(HttpMethod.GET, "/senior-review/cases").hasRole("SENIOR_REVIEWER")
                .requestMatchers(HttpMethod.POST, "/senior-review/cases/*/resolve").hasRole("SENIOR_REVIEWER")
                .requestMatchers(HttpMethod.POST, "/reviews/batch").hasAnyRole("REVIEWER", "SENIOR_REVIEWER")
                .requestMatchers(HttpMethod.POST, "/submissions/*/review-difficulty").hasRole("REVIEWER")
                .requestMatchers(HttpMethod.POST, "/submissions/*/ledger-entries").hasAnyRole("REVIEWER", "SENIOR_REVIEWER")
